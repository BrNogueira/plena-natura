    ...
    <form method="post">
        ...
        <div class="form-row" id="sex">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="name" class="form-control" id="validationServer03" value="{{$product->name}}"
        ...
        <div class="form-row">
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" name="sku" required id="validationServer03"
                    value="{{$product->sku}}" placeholder="SKU">
            </div>
            <div class="col-md-3 mb-3">
                <label for="validationServer03">GTIN</label>
                <input type="text" class="form-control" name="gtin" required id="validationServer03"
                    value="{{$product->gtin}}" placeholder="GTIN" maxlength="14">
            </div>
            <div class="col-md-3 mb-3">
                <label for="validationServer03">NCM</label>
                <input type="text" class="form-control" name="ncm" required id="validationServer03"
                    value="{{$product->ncm}}" placeholder="NCM" maxlength="8">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" id="validationServer03" required name="real_price"
                    value="{{number_format($product->real_price, 2)}}" placeholder="0.00">
            </div>
            <div class="col-md-3 mb-3">
                <label for="validationServer03">Preço de Venda (R$)</label>
                <input type="text" class="form-control" id="validationServer03" required name="price"
                    value="{{number_format($product->price, 2)}}" placeholder="0.00">
            </div>
            <div class="col-md-3 mb-3">
                <label for="validationServer03">Preço Promocional (R$)</label>
                <input type="text" class="form-control" id="validationServer03" required name="promotion_price"
                    value="{{number_format($product->promotion_price, 2)}}" placeholder="0.00">
            </div>

            <div class="col-md-3 mb-3">
                <label for="validationServer03">Estoque</label>
                <input type="text" class="form-control" required name="stock" value="{{$product->stock}}"
        ...
        <div class="form-row">
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" id="validationServer03" required name="weight"
                    value="{{number_format($product->weight, 2)}}" placeholder="">
            </div>
            <div class="col-md-3 mb-3">
                <label for="validationServer03">Peso Bruto</label>
                <input type="text" class="form-control" id="validationServer03" required name="gross_weight"
                    value="{{number_format($product->gross_weight, 2)}}" placeholder="">
            </div>
            <div class="col-md-3 mb-3">
                <label for="validationServer03">Data de Validade</label>
                <input type="date" class="form-control" id="validationServer03" required name="expires_at"
                    value="{{$product->expires_at}}" placeholder="">
            </div>
            <div class="col-md-3 mb-3">
        ...
        <div class="form-row">
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" name="width" value="{{number_format($product->width, 2)}}"
                    id="validationServer03" placeholder="Largura">
            </div>
            <div class="col-md-3 mb-3">
                <label for="validationServer03">Altura</label>
                <input type="text" class="form-control" name="heigth" value="{{number_format($product->heigth, 2)}}"
                    id="validationServer03" placeholder="Altura">
            </div>
            <div class="col-md-3 mb-3">
                <label for="validationServer03">Comprimento</label>
                <input type="text" class="form-control" name="length" value="{{number_format($product->length, 2)}}"
                    id="validationServer03" placeholder="Comprimento">
            </div>
            <div class="col-md-3 mb-3">
        ...
        <fieldset id="upload_img" method="post" class="nf_class upload_img">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="div_conteudo">
                    <form id="createCategory">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input type="text" required class="form-control" id="categoria_xd"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="icon" required class="form-control" placeholder="fa fa-icon"
                                    id="inputIcon">
                        ...
                        <br />
                        <button type="button" class="btn btn-success botao_verde btn_carrega_conteudo"
                            id="btnCreateCategory" data-dismiss="modal">Cadastrar</button>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="div_conteudo">
                    <form id="createBrand">
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" required class="form-control" placeholder="Nome do fornecedor"
                                    name="name">
                            </div>
                        </div>
                        <br />
                        <button type="button" class="btn btn-success botao_verde btn_carrega_conteudo"
                            id="btnCreateBrand" data-dismiss="modal">Cadastrar</button>
                </div>
            </div>
        </div>
    </div>
    	...
    	for(var i = 0, f; f = files[i]; i++)
    	{
			...
			reader.onload = (function(theFile)
			{
			   	return function(e)
			   	{
		            ...
		            span.innerHTML = "<a href='#'><img style='float:left;padding: 3px;height: 33px; width: 33px; border: 1px solid #c7c7c7;margin-top: 0px;' src='" + e.target.result + "'" + "title='" + escape(theFile.name) + "'/></a>";
...
<script src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=y3qwhx7dd59gllbzhzcodgqe5i0c2f7mbfft0etu2qehglrh">
</script>
<script>
    tinymce.init({
        selector: 'textarea'
